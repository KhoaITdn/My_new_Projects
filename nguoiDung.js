...
function addOrder(dh) {
        ...
        s += `
                <tr>
                    ...
                    <td class="noPadding imgHide">
                        <a target="_self" href="chitietsanpham.html?` + p.name.split(' ').join('-') + `" title="Xem chi tiết">
                            ` + p.name + `
                            <img src="` + p.img + `">
                        </a>
                    </td>
                    ...
                    <td class="alignRight">` + numToString(thanhtien + 35000) + ` ₫</td>
    ...
    s += `
                <tr style="font-weight:bold; text-align:center; height: 4em;">
                    ...
                    <td class="alignRight">` + numToString(totalPrice + 35000) + ` ₫</td>
                    <td > ` + dh.tinhTrang + ` </td>
                </tr>
            </table>
            <hr>
