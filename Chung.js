...
function addTopNav() {
	...
	<nav class="header__navbar">
        <ul class="header__navbar-list">
            ...
            <li class="header__navbar-item">: <a href="tel:+84 123456789">+84763767139</a></li>
        </ul>
            ...
            <div class="header__search-input-wrap">
                <form class="input-search" method="get" action="index.html">
                    <div class="autocomplete">
                        <input id="search-box" name="search" type="text" class="header__search-input" autocomplete="off" placeholder="Bạn tìm gì ở Lovell Garden❤️❤️❤️">
...
function addFooter() {
        ...
        <div class="footer-one__contact">
            ...
            <ul class="footer-one__list">
                <li class="footer-one__item">
                    ...
                    Lovell Garden xin cảm ơn quý khách đã ghé thăm.
                </li>
                <li class="footer-one__item">
                    <i class="footer-one-item__icon fa-solid fa-location-dot"></i>
                    Nhà Vườn: Lovell Garden - Nam Ô - Đà Nẵng.
                </li>
                <li class="footer-one__item">
    ...
    <div class="footer-two">
        <div class="grid">
            <p class="footer-two__text">Lovell Garden xin cảm ơn quý khách đã ghé thăm.
            </p>
        </div>
    </div>
    `);
